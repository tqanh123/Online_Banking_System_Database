...
if (isset($_GET['deleteBankAcc'])) {
  ...
  $adn = "DELETE FROM  bankAccounts  WHERE Account_Number = ?";
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="manage_acc_openings.php">iBank Accounts</a></li>
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-success btn-sm" href="update_user_accounts.php?account_id=<?php echo $row->Account_Number; ?>">
                            <i class="fas fa-cogs"></i>
                            <!-- <i class="fas fa-briefcase"></i> -->
                            Manage
                          </a>

                          <a class="btn btn-danger btn-sm" href="manage_acc_openings.php?deleteBankAcc=<?php echo $row->Account_Number; ?>">
