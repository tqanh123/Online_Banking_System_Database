...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        //get total amount transfered to others
        $account_id = $_GET['account_id'];
        ...
        //get total amount transfered from others
        $account_id = $_GET['account_id'];
        ...
        while ($row = $res->fetch_object()) {
            ...
            //compute the balance
            $money_in = $deposit - $Transfer_received - $money_out;
            //get the rate
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1><?php echo $row->Cus_Name; ?> iBanking Account Balance</h1>
                            </div>
                            <div class="col-sm-6">
                                    ...
                                    <div class="row invoice-info">
                                        <div class="col-sm-6 invoice-col">
                                            ...
                                            <address>
                                                ...
                                                National : <?php echo $row->National; ?>
                                            </address>
                                        </div>
                                        <!-- /.col -->
                                        <div class="col-sm-6 invoice-col">
                                            ...
                                            <table class="table table-hover table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>$ <?php echo $Transfer_received; ?></td>
