...
if (isset($_POST['update_acc_type'])) {
    ...
    $query = "UPDATE  Acc_types SET name=?, description=?, rate=? WHERE acctype_ID=? ";
    $stmt = $mysqli->prepare($query);
    //bind paramaters
    $rc = $stmt->bind_param('ssss', $name, $description, $rate, $acct_ID);
    $stmt->execute();
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        //fetch a Acc_types
        $acct_ID = $_GET['code'];
        $ret = "SELECT name, description, rate FROM  Acc_types WHERE acctype_ID = ? ";
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class=" col-md-4 form-group">
                                                    ...
                                                    <input type="text" readonly name="code" value="<?php echo $acct_ID; ?>" readonly class="form-control" id="exampleInputPassword1">
                                                </div>
                                            </div>
