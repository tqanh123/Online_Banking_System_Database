...
if (isset($_POST['create_staff_account'])) {
    ...
    $query = "INSERT INTO Customers (cus_name, national, phone, email, password, address, profile_pic, Date_of_Birth) VALUES (?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    //bind paramaters
    $rc = $stmt->bind_param('ssssssss', $name, $national, $phone, $email, $password, $address, $profile_pic, $birth);
    $stmt->execute();
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="pages_add_client.php">iBanking User</a></li>
                                ...
                                <form method="post" enctype="multipart/form-data" role="form">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" col-md-6 form-group">
                                                <label for="exampleInputPassword1">National</label>
                                                <input type="text" name="national" required class="form-control" id="exampleInputEmail1">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" name="create_staff_account" class="btn btn-success">Add User</button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card -->
