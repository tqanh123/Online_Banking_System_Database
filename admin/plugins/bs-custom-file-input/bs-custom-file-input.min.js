...
//     },
//     n=!!window.File,
//     l=function(e){if(e.hasAttribute("multiple")&&n)return[].slice.call(e.files).map(function(e){return e.name}).join(", ");

//     if(-1===e.value.indexOf("fakepath")) 
//         return e.value;
//     var t=e.value.split("\\");return t[t.length-1]};
...
//         },
//         destroy:function(){
//             for(var e=[].slice.call(document.querySelectorAll(d.FORM)).filter(function(e){return!!e.bsCustomFileInput}),
//                 t=[].slice.call(document.querySelectorAll(d.INPUT)).filter(function(e){return!!e.bsCustomFileInput}),
