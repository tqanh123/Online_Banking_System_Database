...
if (isset($_POST['open_account'])) {
    ...
    $query = "INSERT INTO BankAccounts (Acc_Name, Account_Number, Acctype_ID, acc_rates, Acc_Status, Acc_Amount, Customer_id, client_name, client_national_id, client_phone, client_number, client_email, client_adr) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    //bind paramaters
    $rc = $stmt->bind_param('ssssssssssss', $Acc_Name, $Account_Number, $Acctype_ID, $Acc_Status, $Acc_Amount, $Customer_id, $client_name, $client_national_id, $client_phone, $client_number, $client_email, $client_adr);
    $stmt->execute();

    //declare a varible which will be passed to alert function
    if ($stmt) {
        $success = "Online Banking Account Opened";
    } else {
