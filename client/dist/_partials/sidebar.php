<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  while ($row = $res->fetch_object()) {
    ...
    if ($row->Profile_pic == '') {
      $profile_picture = "<img src='../client/dist/img/user_icon.png' class=' elevation-2' alt='User Image'>
                ";
    } else {
      $profile_picture = "<img src='../client/dist/img/$row->Profile_pic' class='elevation-2' alt='User Image'>
                ";
    }
  ...
  ?>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block"><?php echo $row->Cus_Name; ?></a>
          </div>
        </div>
